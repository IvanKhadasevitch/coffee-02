...
<form class="form-horizontal" action="frontController?command=addCoffee" method="post">
    <div class="form-group">
        <c:choose>
            <c:when test="${sessionScope.coffeeTypeForAdd.disabled eq 'Y'}">
    ...
    <div class="input-group col-sm-offset-4 col-sm-1">
        <button type="submit" class="btn btn-success"><fmt:message bundle="${i18n}" key="coffee.add.submit"/></button>
    </div>
</form>
